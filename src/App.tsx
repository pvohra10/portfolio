...
// 1. Defined the interface for props
...
function App() {
  ...
  // FIX for error TS7006: Added React.MouseEvent type to 'e'
  const handleContactClick = (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    setTimeout(() => {
      ...
      // FIX for error TS2531: Added null check before calling scrollIntoView
      if (contactSection) {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 selection:bg-blue-500/30">
        ...
        <section id='about' className="py-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-slate-400 text-lg leading-relaxed bg-slate-900/50 p-6 rounded-lg">
              I'm a passionate Computer Engineering student at the University of Waterloo, specializing in software development and AI.
            </p>
          </div>
        </section>
      ...
      <section id="contact">
        <div className="max-w-6xl mx-auto px-8">
          <div className="py-20 border-t border-slate-900">
            ...
            <p className="text-slate-400 mb-8">Reach out if you have a project in mind!</p>
      ...
      <footer className="py-12 border-t border-slate-900 text-center">
        <p className="text-slate-500 text-sm">© {new Date().getFullYear()} Parth Vohra.</p>
      </footer>
    </div>
  )
}

// FIX for error TS7031: Explicitly used the interface for destructuring props
